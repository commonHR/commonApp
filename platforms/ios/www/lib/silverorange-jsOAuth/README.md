...
Download the [minified library](https://github.com/downloads/bytespider/jsOAuth/jsOAuth-1.4.0so1.min.js) and include it in your html.

	<script type="text/javascript" src="library/jsOAuth-1.4.0so1.min.js"></script>
